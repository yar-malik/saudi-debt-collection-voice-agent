...
said = " ".join(sys.argv[1:]) or "أبي أعرف كم المتبقي علي ومتى آخر موعد"
...
if not agent_id:
    ...
    audio = voho("/v1/speech", {"text": "أهلاً، معك ليلى من النخبة بخصوص فاتورة مستحقة. هل هذا وقت مناسب؟", "voice": "layla", "model": "sada-1", "format": "mp3"}, raw=True)
...
out = voho("/v1/agents/%s/reply" % agent_id, {
    "text": said,
    "variables": {"company": os.environ.get("VOHO_COMPANY", "النخبة")},
})
